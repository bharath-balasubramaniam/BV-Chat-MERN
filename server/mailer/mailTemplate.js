  ...
  <html>
    ...
    <body>
      <div style="margin : 0 auto; max-width: 400px; border:1px solid lightgray; border-radius:5px; padding:1rem; text-align:center;">
        ...
        <a href=https://bv-chat-reset-password.netlify.app/${randomStr} "target="_blank"  style="font-size: 1rem; padding:0.5rem; border:2px solid black;background-color: transparent;color: grey; border-radius:5px; text-decoration:none;font-family:cursive ; cursor:pointer;">Reset Now</a>
      </div>
    </body>
  </html>`;
};
